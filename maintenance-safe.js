...
function bulkValue(p,name){
  if(['朝食向き','昼食向き','夕食向き','軽食向き','アルコール向き','休憩向き','観光向き','買い物向き','雨の日向き','子ども向き','高齢者向き','一人向き','短時間立寄り向き','営業日','営業時間','定休日','最短滞在時間_分','推奨滞在時間_分','最大滞在時間_分'].includes(name)){
...
window.saveBulkEditor=function(){
  ...
  document.querySelectorAll('#bulkTable [data-bulk-key][data-bulk-field]').forEach(e=>{
    ...
    if(['朝食向き','昼食向き','夕食向き','軽食向き','アルコール向き','休憩向き','観光向き','買い物向き','雨の日向き','子ども向き','高齢者向き','一人向き','短時間立寄り向き','最短滞在時間_分','推奨滞在時間_分','最大滞在時間_分'].includes(field)){
